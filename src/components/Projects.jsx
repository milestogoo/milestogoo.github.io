      ...
      <div className="mt-6 grid gap-6 sm:grid-cols-2">
        {projects.map((project) => (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group overflow-hidden rounded-lg border border-gray-200 transition hover:border-indigo-300 hover:shadow-sm dark:border-gray-800 dark:hover:border-indigo-700"
          >
            <div className="h-1 bg-indigo-600 opacity-0 transition group-hover:opacity-100" />
            <div className="p-5">
